...
namespace System
{
    public static class ObjectExtensions
    {
        public static string ToJsonExt<T>(this T obj)
        {
            ...
            return JsonConvert.SerializeObject(obj, JsonSerializerSettingConst.DefaultSetting);
        }
...
#pragma warning restore IDE0060 // 删除未使用的参数
        ...
        /// 当<paramref name="source"/>为null时会引发此异常
        /// </exception>
        /// <exception cref="TypeAccessException">
        /// 当<paramref name="source"/>为数组类型时引发此异常
        /// </exception>
