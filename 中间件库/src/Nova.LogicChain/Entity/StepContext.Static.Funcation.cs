namespace Nova.LogicChain.Entity
{
    ...
    public abstract partial class StepContext
    {
        ...
        /// 初始化后的上下文是否已经完成任务。用来初始化<see cref="StepContext.ProcessCompleted"/>属性
        /// </param>
        ...
        public static StepContext<object> CreateContext(
            object initObject = null,
            bool completed = false)

        {
            initObject = initObject ?? new object();
            StepContext<object> context = new StepContext<object>(initObject, completed);
