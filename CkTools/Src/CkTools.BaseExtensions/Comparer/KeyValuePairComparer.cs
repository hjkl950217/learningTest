...
namespace CkTools.BaseExtensions.Comparer
{
    ...
    {
        private readonly Func<KeyValuePair<TKey, TValue>, KeyValuePair<TKey, TValue>, bool> equalsFunc;
        ...
        {
            this.equalsFunc = equalsFunc ??= (x, y) => EqualityComparer<KeyValuePair<TKey, TValue>>.Default.Equals(x, y);
        }
