...
namespace CkTools.Abstraction.Test.Extensions
{
    public class ByteExtensionsTest
    {
        public class BytesToHexstring
        {
            ...
            public void NoError()
            {
                string result = testBytes.BytesToHexstring(separator: " ".AsSpan(), uppercase: true);
            ...
            {
                string result = testBytes.BytesToHexstring(separator: " ".AsSpan(), uppercase: false);
            ...
            {
                string result = testBytes.BytesToHexstring(separator: ReadOnlySpan<char>.Empty, uppercase: true);
