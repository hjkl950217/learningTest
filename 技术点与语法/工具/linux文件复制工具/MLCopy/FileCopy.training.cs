...
namespace Linux文件复制工具
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\2A023\Desktop\工作簿1.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col1",outputColumnName:@"col1")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=4,MinimumExampleCountPerLeaf=5,NumberOfTrees=4,MaximumBinCountPerFeature=26,FeatureFraction=0.453557275712173,LearningRate=0.999999776672986,LabelColumnName=@"col0",FeatureColumnName=@"Features",DiskTranspose=false}),labelColumnName: @"col0"))      
